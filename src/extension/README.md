...
- **Side panel UI** – `src/popup/Popup.tsx` (React) is mounted from `main.tsx`; the panel is opened via the toolbar icon and uses `index.html` as its default path in the manifest.
